			...
			<div class="box-body">
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nama" id="nama" value="<?= $sp['nama_supplier']; ?>" placeholder="Masukan Nama Supplier">
					</div>
					<div class="form-group">
						<label>Alamat</label>
						<input type="text" class="form-control" name="alamat" id="alamat" value="<?= $sp['alamat']; ?>" placeholder="Masukan Alamat Supplier">
					</div>
